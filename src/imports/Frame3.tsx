import svgPaths from "./svg-iti5xcb6fn";
...
function P1() {
  return (
    <div className="h-[60px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['PP_Monument',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-white top-[0.5px] w-[484px]">{`"I was struggling to make $200/month on YouTube with 85K subscribers. Within 3 months on ARK, I'm consistently earning over $1,500 from just 8 detailed projects."`}</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[356px] left-0 top-[161.59px] w-[1216px]" data-name="Container">
      <MotionDiv />
      <MotionDiv1 />
    </div>
  );
...
function H() {
  return (
    <div className="absolute h-[61.594px] leading-[61.6px] left-0 not-italic text-[40px] top-[60px] tracking-[-0.5px] uppercase w-[1216px] whitespace-nowrap" data-name="h1">
      <p className="absolute font-['PP_Monument_Extended',sans-serif] left-[0.5px] text-[#fafafa] top-0">Turn Your Projects Into</p>
      <p className="absolute bg-clip-text bg-gradient-to-r font-['PP_Monument_Extended',sans-serif] from-[#1782ff] left-[514px] text-[transparent] to-[#b02bed] top-0">Passive Income</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute h-[121.594px] left-0 top-0 w-[1216px]" data-name="Container">
      <H />
      <Container30 />
    </div>
  );
