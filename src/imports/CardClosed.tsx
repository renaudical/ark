import svgPaths from "./svg-c5xayjpape";
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[16px] relative shrink-0 w-full" data-name="Container">
      ...
      <p className="font-['PP_Monument_Normal:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#bebec8] text-[0px] text-[12px] w-[342px]">
        <span className="leading-[normal]">{`I design practical 3D models that people can actually print and use. Most of my projects are small tools, desk gadgets, and mechanical parts that are... `}</span>
...
function Container7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pb-[16px] relative shrink-0 w-full" data-name="Container">
      ...
      <p className="font-['PP_Monument_Normal:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[14px] text-white w-[264px]">Autonomous Delivery Robot</p>
      <Frame3 />
      <Frame4 />
    </div>
  );
...
function Container8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['PP_Monument_Normal:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[14px] text-white w-[264px]">Custom 3D Printed Drone Frame</p>
      <Frame5 />
      <Frame6 />
    </div>
  );
...
export default function CardClosed() {
  return (
    <div className="bg-[rgba(10,10,10,0.4)] relative rounded-[2px] size-full" data-name="Card/Closed">
